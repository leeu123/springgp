...
<body>
	...
	<c:forEach items="${palist}" var="vo" varStatus="status">   <!--  vo 에 가져온 데이터를 입력  -->
			...
			<tr>
						<td><a
							href="partyinfore?pnum=${vo.pnum}">${status.count}</a></td>
						<td><a
							href="partyinfore?pnum=${vo.pnum}">${vo.title }</a></td>
						<td><a
							href="partyinfore?pnum=${vo.pnum}">${vo.preprice }</a></td>
						<td><a
							href="partyinfore?pnum=${vo.pnum}">${vo.nick }</a></td>	
						<td><a
							href="partyinfore?pnum=${vo.pnum}">${vo.pdate }</a></td>
					</tr>
